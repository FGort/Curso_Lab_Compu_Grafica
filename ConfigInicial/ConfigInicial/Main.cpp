//García Ortega Fernanda     320301159
//Fecha de entrega: 13/02/2026    Práctica 1 
#include<iostream>
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 0 - Fernanda Garcia Ortega", nullptr, nullptr);
