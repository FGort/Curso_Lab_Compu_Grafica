// Practica 05				García Ortega Fernanda 
//Fecha de entrega: 12/03/2026		320301159
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico - Practica 5 - Garcia Ortega Fernanda", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		color = glm::vec3(0.96f, 0.55f, 0.65f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		color = glm::vec3(0.95f, 0.90f, 0.40f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		color = glm::vec3(0.95f, 0.65f, 0.35f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//INDICE (DEDO 1)
		// Dedo 1A
		model = glm::translate(modelTemp2, glm::vec3(0.2f, 0.35f, -0.375f));
		...
		color = glm::vec3(0.40f, 0.75f, 0.50f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.15f));
		color = glm::vec3(0.45f, 0.70f, 0.90f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		color = glm::vec3(0.60f, 0.45f, 0.75f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//MEDIO (DEDO 2)
		//Dedo 2A
		model = glm::translate(modelTemp2, glm::vec3(0.2f, 0.35f, -0.15f));
		...
		//Dedo 2B
		model = glm::translate(modelTemp, glm::vec3(0.43f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo2B), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.2f, 0.15f));
		color = glm::vec3(0.45f, 0.70f, 0.90f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		//Dedo 2C
		model = glm::translate(modelTemp, glm::vec3(0.36f, 0.0f, 0.0f));
		...
		//MEÑIQUE (DEDO 4 
		//Dedo 4A
		model = glm::translate(modelTemp2, glm::vec3(0.07f, 0.35f, 0.375f));
...
void Inputs(GLFWwindow* window) {
	...
	// Para manejar la articulación de las partes  B  de los dedos 
	...
	// Para manejar la articulación de las partes C de los dedos 
